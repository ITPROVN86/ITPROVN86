...
- **Fall 2024** :
   - Building an application platform to connect **tourists** and locals. Utilizes ASP.NET Web API, SQL Server, React JS, and React Native.
   - Building a Book and Stationery Sales Website for a **Bookstore** using .NET technology, ReactJS, RESTful API, and SQL Server.
   - Building a recipe management and **book distribution** website using .NET technology, ReactJS, RESTful API, SQL Server.
   - Building an **Online Auction** Website in Da Nang using .NET technology, ReactJS, RESTful API, SQL Server.

- **Spring 2025** :
   - Building a **Da Nang Sports** Field Management and Booking System using ASP.NET CORE API, VueJS and SQL Server.
   - Build an **online art gallery** application using NextJS, Nodejs, ExpressJS, WebGL, MongoDB.
   - Building a system for **Learning Vietnamese History** through Images and Museum Artifacts using ReactJS, ASP.NET Core API, SQL Server.
   - VirtualMeet - Versatile **Virtual Meeting** Platform using ASP.NET Core API, Angular, WebRTC, SignalR, MongoDB, and SQL Server.

- **Summer 2025** :
   - Building a Scientific Conference Organization and Management System at FPT University Da Nang Using ASP.NET Core API, ReactJS, SQL Server Database
   - Build an Online Life Skills Training Platform Using ASP.NET Core API, Razor Pages and SQL Server
   - Online meeting platform using Sign Language using ASP.NET Core API, NextJS, PostgreSQL, AI Deep Learning
   - Build a 2D platform game for 2 players to coordinate puzzle solving, fight enemies, pass levels, and compete online with 4 players, using technologies Unity, MySQL, ASP.NET Core API
